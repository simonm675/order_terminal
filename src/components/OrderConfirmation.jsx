...
const OrderConfirmation = () => {
  ...
  return (
    <motion.div
      className="relative flex flex-col min-h-screen justify-center bg-white shadow-lg rounded-lg max-w-3xl mx-auto p-6 my-8"
    ...
    >
      ...
      <div className="flex justify-center mb-8">
        <img
          className="w-48 h-48"
          src="https://via.placeholder.com/300" // Hier könntest du ein Bild für die Bestätigung verwenden
      ...
      <div className="text-center">
        <p className="text-lg text-gray-800 mb-4">
          Ihre Bestellnummer lautet: <span className="font-bold">#123456</span>
        </p>
